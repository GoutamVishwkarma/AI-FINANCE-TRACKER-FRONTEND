...
export default function DashboardPage() {
  ...
  const expensesByType = [
    { name: 'Food & Dining', amount: 1250.50, percentage: 35, color: 'bg-amber-500', icon: Utensils },
    { name: 'Shopping', amount: 980.20, percentage: 28, color: 'bg-blue-500', icon: ShoppingBag },
    { name: 'Transportation', amount: 650.00, percentage: 18, color: 'bg-green-500', icon: Car },
    { name: 'Entertainment', amount: 490.30, percentage: 14, color: 'bg-red-500', icon: Film },
    { name: 'Others', amount: 185.00, percentage: 5, color: 'bg-purple-500', icon: Coffee },
  ];

  const incomeByType = [
    { name: 'Salary', amount: 15000.00, percentage: 75, color: 'bg-emerald-500', icon: DollarSign },
    { name: 'Freelance', amount: 2500.00, percentage: 15, color: 'bg-cyan-500', icon: Wallet },
    { name: 'Investments', amount: 950.00, percentage: 10, color: 'bg-indigo-500', icon: TrendingUp },
  ];
        ...
        <main className="w-full max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <p className="text-lg text-slate-600">Welcome back! Here's your financial overview</p>
            </div>
            <Button 
              onClick={() => setShowAddExpense(true)}
              className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 shadow-xl shadow-indigo-500/30 border-0 font-bold rounded-xl px-8 h-12 text-white transition-all hover:scale-105"
            >
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-10">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className={`rounded-2xl border-2 ${stat.borderColor} ${stat.bgColor} p-6 shadow-lg hover:shadow-xl transition-all`}>
                  <div className="flex items-start justify-between mb-4">
                    <div className={`w-14 h-14 rounded-xl bg-white/80 backdrop-blur flex items-center justify-center shadow-md`}>
                    ...
                    return (
                      <div key={tx._id} className="flex items-center justify-between p-3 rounded-xl border border-slate-100 hover:bg-slate-50 transition-all">
                        ...
                        <div className="text-right">
                          <p className={`font-bold ${tx.type === 'income' ? 'text-emerald-600' : 'text-rose-600'}`}>${Number(tx.amount).toFixed(2)}</p>
          ...
          <div className="grid gap-8 lg:grid-cols-2 mb-10">
            ...
            <div className="rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-slate-900">Last 30 Days Expenses</h2>
                  <p className="text-sm text-slate-500 mt-1">By category</p>
                </div>
                <Button variant="ghost" className="text-rose-600 hover:text-rose-700 hover:bg-rose-50 font-semibold">
                  View All
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-black text-rose-600">$3,555.00</span>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border-2 border-slate-200 bg-white p-8 shadow-lg hover:shadow-xl transition-all">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-slate-900">Last 60 Days Income</h2>
                  <p className="text-sm text-slate-500 mt-1">By source</p>
                </div>
                <Button 
                  variant="ghost" 
              ...
              <div className="mt-6 pt-4 border-t border-slate-200">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-black text-emerald-600">$18,450.00</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-8 shadow-xl">
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-3">
                  <h2 className="text-3xl font-black text-slate-900">AI Financial Assistant</h2>
